...
2. To set or change the firmware password for a single device:
   1. Click the user name the device is associated with to view the device details page.
   2. In the General section, expand **Firmware Password** and click **Set Password** or click **Set/Change Firmware Password&#x20;**&#x66;rom the device Actions menu.
   3. The following information is displayed in this section:
      1. **Password:** Password or a list of probable passwords.
