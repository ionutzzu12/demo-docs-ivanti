...
will not send email intimations and user interface notifications to the administrator about the license details, such as the license expiration date, the total number of available licenses, or the total number of licenses exceeding the usage limit. Additionally, will hide specific information relating to licenses in the Account section.
