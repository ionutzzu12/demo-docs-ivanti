...
| **Access Point Type**         | Select the type of access point from the following options:<br />* **Default**
* **DUN**
* **IMS**
* **Emergency**
* MMS
...
* **FOTA**
* **IA**                                                                                                                                   |
| **MVNO Type**                 | Select the type of Mobile Virtual network Operator from the following options:<br />* **None**
* **SPN**
* **IMSI**
* **GID**
* **ICCID**                                                                                                                                                                                 |
| **Bearer**                    | Select the type of bearer service used for data transmission from the following options:<br />* **1xRTT**
* **CDMA**
* **EDGE**
* **EHRPO**
* **EVDO**
...
* **TD\_SCDMA**
* **UMTS** |
| **APN Protocol**              | Select the APN protocol required for the APN. The following are the available options:<br />* **None**
* **IPV4**
* **IPV6**
* **IPV4/IPV6**
* **NON\_IP**
...
* **UNSTRUCTURED**                                                                                                    |
| **APN Roaming Protocol**      | Select the APN roaming protocol required for the APN. The following are the available options:<br />* **None**
* **IPV4**
* **IPV6**
* **IPV4/IPV6**
* **NON\_IP**
...
| **Authentication Type**       | Select the type of authentication protocol from the following options:<br />* **None**
