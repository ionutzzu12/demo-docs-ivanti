...
Create a temporary support administrator to enable the service support team to log in with your [**roles**](<./User Roles.md>) and permissions. This user expires automatically in 7 days, or you can end access at any time. Creating a support administrator makes it easier for the support team to troubleshoot issues.
