...
5. Navigate to one of the applications listed on the page. See [**Apple documentation**](https://developer.apple.com/documentation/devicemanagement/privacypreferencespolicycontrol/services) for related information.
   1. For macOS 10.14+, the applications and settings available for configuration include:
   ...
   2. For macOS 10.15+, the applications and settings available for configuration include:
