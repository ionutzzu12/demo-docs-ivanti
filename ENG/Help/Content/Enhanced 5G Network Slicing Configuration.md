...
- **Work Profile**- On employee-owned devices with a Work Profile configured using Android Enterprise version 12.0, the "Enable 5G Network Slicing" checkbox can be found under
  **Configuration Setup > Work Profile Lockdown Settings**.
