...
Though you cannot upload new documents to , you can provide a path (URL) where the content is hosted and distribute it to the device groups.
...
If you cannot perform tasks on the **Content** page, it might be that you do not have the required permissions. You need the following [**role**](<./User Roles.md>):
