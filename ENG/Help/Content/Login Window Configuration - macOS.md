...
6. Under the **Configuration Setup** section, provide the following fields:
   - **Admin Host Info**: Enter the hostname or IP address or SystemVersion.
   ...
   - Select the checkbox for additional options like:
