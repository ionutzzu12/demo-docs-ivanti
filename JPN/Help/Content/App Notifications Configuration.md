...
7. 通知設定を構成します。 選択できる通知は次のとおりです。
   - 通知を許可
     ...
     - バッジアプリアイコン
     - ロック画面に表示
     - （iOS 12.0+監視対象）CarPlayを使用する際に重大なアラートを表示
     - （iOS 12.0+監視対象）重大なアラートの有効化を許可（「おやすみモード」を無視）
   ...
   - （iOS 12.0+監視対象）グループ化のタイプ
     - 自動
     - アプリ別
     - オフ

   - （iOS 14.0+）通知プレビューのタイプ - デバイスの通知メッセージプレビューに表示するプレビューのタイプを選択します。
     - ユーザ制御 - デバイス上のアプリのユーザ設定に従ってメッセージプレビューを表示します。
     - 常時 - メッセージプレビューを表示します。
