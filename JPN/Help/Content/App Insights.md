...
- 青はアプリがインストールされたデバイス数を示します。 グラフの青い領域をクリックすると **[デバイス]** ページが開きます。 デ**バイス **ページの ア**プリ バージョン **列には、インストールされているアプリのバージョンとアプリがインストールされた日付が表示されます。
左側のパネルの「 バ**ージョン **」セクションからオプションを選択して、インストールされているアプリのバージョンに基づいてデバイスを表示することもできます。
...
2. **[グラフのタイプ]** ドロップダウンリストから **[シングルアプリ配布]** を選択します。
3. 単一アプリの分布チャートを表示するアプリのリストのチェックボックスを選択します。

または、「アプリの検索」フィールドにアプリ名を入力して、特定のアプリを検索することもできます。
4. **[グラフを追加]** をクリックします。 単一アプリの分布チャートは、「アプリ」ページに表示されます。

リストから最大 9 個のアプリを選択できます。
...
1. **[アプリ]** ページの **[+追加]** をクリックします。 **[アプリグラフを追加]** ウィンドウが表示されます。
2. **[グラフのタイプ]** ドロップダウンリストから **[非マネージドiOSアプリ]** を選択します。
3. **[グラフを追加]** をクリックします。 非マネージドiOSアプリのグラフが **[アプリ]** ページに表示されます。


このグラフは、アプリカタログ内にある非マネージドのアプリ数を表示します。 グラフの一番下には、以下の詳細を記載した3つの列があります。
...
1. **[非マネージドiOSアプリを持つデバイス] 列**で数字のリンクをクリックします。 **[非マネージドiOSアプリ]** ウィンドウが表示されます。
2. リストから1つ以上の非マネージドアプリを選択し、[非マネージドiOSアプリ] の下の数字リンクをクリックします。 選択したアプリは管理対象アプリに変換され、次回のデバイスチェックイン時にステータスが更新されます。 **CSV にエクスポート** リンクをクリックすると、管理対象外アプリのデータを CSV 形式でエクスポートできます。
...
1. **[アプリ]** ページの **[+追加]** をクリックします。 **[アプリグラフを追加]** ウィンドウが表示されます。
2. **[グラフのタイプ]** ドロップダウンリストから **[インストールされたマネージドアプリ上位10件]** を選択します。
...
1. **[アプリ]** ページの **[+追加]** をクリックします。 **[アプリグラフを追加]** ウィンドウが表示されます。
2. **[グラフのタイプ]** ドロップダウンリストから **[最も評価の高い自社開発アプリ5件]** を選択します。
3. **[グラフを追加]** をクリックします。 最も評価の高い自社開発アプリ5件のグラフが **[アプリ]** ページに表示されます。


このグラフは、アプリのロゴ経由でデータと星の数による評価を表示します。 星の数による評価は、星の絵と整数で表示されます（最高評価は5）。 アプリを評価したユーザ数も表示されます。

アプリに対する評価の数は、その管理者が管理するデバイスに限らす、そのアプリの全ユーザの評価を含みます。 評価は、自分の登録デバイスのApps@Workからそのアプリを見た各ユーザによるものであり、そのアプリに対するすべての評価の平均です。
