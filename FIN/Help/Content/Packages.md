...
This section describes the legacy Bronze, Silver, and Gold packages. The packaging has evolved to the [**Secure UEM and Secure UEM Premium**](#h2_2) scheme.

### [****](#)Bronze

Ivanti Neurons for MDM basic features are provided in the package. You can expand the package by:
...
Administrators can contact [**Support**](<./Opening a Support Ticket.md>) if they are interested in enabling one or more of the [**On-demand features**](<./On-demand features.md>) on their tenant(s) that are disabled by default.

### [****](#)Silver

Upgrading to adds the following features:
...
Upgrading to adds the features provided by as well as the following features:
...
Upgrading to Platinum adds the features provided by as well as the following features:
