...
Remove Bloatware configuration allows you select the list of applications installed in devices which needs to be forcibly removed. It is a prerequisite to have a Bridge setup for this configuration. See [**Bridge**](<./Ivanti Bridge.md>) for more details.
