...
| ![](info_icon.png) | You can use the variables displayed on the right in the body of the email. See [**Supported email variables**](#Supp). |
| ------------------ | ---------------------------------------------------------------------------------------------------------------------- |
...
| \<ol>            | \["start"]                                                                                                                                                         |
| \<table>         | \["class","width","border","cellspacing","cellpadding","style","height","bgcolor",<br />"align","background"]                                                      |
...
- An admin has [**assigned the custom user attributes to users**](<./Assigning Custom Attributes to Users.md>), with values given for the custom user attributes for each user.
