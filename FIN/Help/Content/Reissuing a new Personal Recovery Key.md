...
When migrating from other MDM solutions to , administrators can request the OS to reissue a new Personal Recovery Key (PRK) upon enrollment if a PRK was previously issued prior to enrollment. This enables the key to be stored in .
...
1. Contact [**Support**](<./Opening a Support Ticket.md>) to request the script to generate new PRK on the device.
