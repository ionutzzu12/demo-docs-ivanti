...
can be integrated with Google BeyondCorp for conditional access. Ivanti Neurons for MDM sends device compliance status signal to Google BeyondCorp. This ensures that only compliant devices under N-MDM can access Google workspace applications.

Prerequisites

- For , you must have an Ivanti Professional Plus / Premium license.
...
5. Click **Open Connection**.
   You will be redirected to the login page; enter the tenant admin credentials. Once you log in to the tenant, you will see that **Google BeyondCorp** is enabled and linked to your Google account automatically.
...
7. Click **Create Access Level**.
   In the Create Access Level window, under the Context conditions section, click **ADVANCED** and provide the required information.
...
10. Once the above setup is complete, you can create the partner device compliance configuration using **Google BeyondCorp**.
