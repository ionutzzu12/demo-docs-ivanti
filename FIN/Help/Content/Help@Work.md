...
**Supported on:** Android and iOS devices as supported by
...
4. If you want to Whitelist the hostnames or override the content security policy, please contact the support team.
...
1. When the session ID is generated, passes it to the TeamViewer QuickSupport app using the managed app configuration, which in turn uses this session ID to invoke the TeamViewer client on the device. For iOS, the session ID expires after 30 minutes.
