...
Go to **Admin** > **System** > **Device Cleanup**. The Device Cleanup page opens.

Select **Retire Device**.

Use the **Retire Devices** table to specify the details.

Click **Show not checked-in device list**. Shows the list of devices that are not checked in for specified number of days.

Click **Retired Devices Now**, alternatively, you can schedule the device retirement.

The administrative portal will retire the specified devices.

Click **Save** to save your setting.

(Optional) If you update the values you can click **Reset** to reset the settings back to the initial settings.
...
| **Retire Schedule Configuration**                                 | Select one of the following options to set the frequency of retirements:<br />* **Daily -&#x20;**&#x53;et to retire devices everyday.
...
6. The administrative portal will delete the specified devices.
...
| **Delete Schedule Configuration**                              | Select one of the following options to set the frequency of deletion:<br />* **Daily -&#x20;**&#x53;et to delete devices everyday.
...
| **Delete Wiped Schedule Configuration**                  | Select one of the following options to set the frequency of deletion:<br />* **Daily -&#x20;**&#x53;et to delete wiped devices everyday.
* **Weekly -&#x20;**&#x53;pecify the day of the week to schedule the deletion.
...
| **Delete Wipe Pending Schedule Configuration**                      | Select one of the following options to set the frequency of deletion:<br />* **Daily -&#x20;**&#x53;et to delete wipe pending devices everyday.
* **Weekly -&#x20;**&#x53;pecify the day of the week to schedule the deletion.
...
6. The administrative portal will retire the specified devices.
7. Click **Save** to save your setting.
8. (Optional) If you update the values you can click **Reset** to reset the settings back to the initial settings.
...
| **Retire the Retire Pending Schedule Configuration**                            | Select one of the following options to set the frequency of deletion:<br />* **Daily -&#x20;**&#x53;et to retire the pending devices everyday.
