...
| Redirect URL to Server                              | Enter the following settings:<br />* Enter **Redirect URL** to which FDE recovery keys should be sent instead of Apple. The URL must begin with https\://.
