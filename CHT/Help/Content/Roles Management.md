...
- View Serve<br />All LDAP permissions in this section require View Connector permission. It will be automatically selected in the Connector section when you select any of these LDAP permissions.                                                                                                                                                                                      |
...
* View Device Custom Attribute<br />All Assign Custom Device Attribute permissions in this section require Device Read permission. It will be automatically selected in the Device Actions section when you select any of these Assign Custom Device Attribute permissions.                                                                                                                                                               |
