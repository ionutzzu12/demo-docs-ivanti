...
Using ADMX browser, you can view the GPO settings organized on the basis of the ADMX objects that exist in the tenant. You can search and view the default ADMX objects and also add (upload) custom ADMX files that provide an XML-based structure for defining the display of the GPO settings
