...
3. Click **Actions**.
4. Select **Unlock**.
5. Alternatively, click the device name link to go to the Device details page and click the **Unlock**![](Unlock_device_icon.png) icon and click **OK**.
...
- (Android only) Provide an unlock code - You can provide an Unlock code from this section and click **Unlock**.
  - Skip passcode reset prompt on device - Select to skip resetting the passcode if the passcode configuration is pushed to a device.
