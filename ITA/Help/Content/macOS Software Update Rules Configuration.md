...
Administrators can configure the software update policy of a device by defining the macOS Software Update Rules.
...
4. Select the required configurations from macOS Software Update Rules.
5. Click Next.
