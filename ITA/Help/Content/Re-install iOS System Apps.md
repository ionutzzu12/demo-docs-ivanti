...
1. Navigate to the [**Devices page**](./Devices-.md). Alternatively, you can click the name of the device and perform this action from the Device Details page.
...
For more information, see [**Software\_Updates**](<./Software Updates.md>).
