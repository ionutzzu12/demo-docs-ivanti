...
1. Open the first browser and log into the Microsoft Azure portal ([**https://portal.azure.com/**](https://portal.azure.com/)).
...
12. Perform the following procedure for admin portal.
...
3. Paste **Application ID** in the admin portal.
4. **Procedure**
...
5. Paste the **Application Secret** (Client Secret) in the admin portal.
6. **Procedure**
   1. Go to the Azure portal.
...
7. Paste the **Tenant ID** in the admin portal.
8. **Procedure**
   1. Go to the Azure portal.
...
9. Enter your Intune admin **Username** and **Password**.
...
10. Click **Authenticate and Save**.
