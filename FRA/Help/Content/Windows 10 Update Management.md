...
En tant qu'administrateur, vous pouvez consulter et approuver les mises à jour proposées par les appareils Windows 10 que vous souhaitez installer via la Gestion des mises à jour Windows 10. Cette fonctionnalité vous permet d'empêcher l'installation de mises à jour inutiles ou non testées.
...
1. Dans la page **Gestion des mises à jour Windows 10**, entrez l'ID de base de connaissances dans le champ de recherche rapide (numéro uniquement dans le champ Rechercher). 
...
Sur la page **Gestion des mises à jour Windows 10**, sélectionnez l'une des options de filtre suivantes en fonction de la distribution configurée : 
