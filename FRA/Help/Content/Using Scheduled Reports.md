...
La fonctionnalité de rapports planifiés vous permet de programmer et de générer des rapports sur différents indicateurs à l'aide de modèles prédéfinis. Vous devez disposer du rôle d'administrateur système ou du rôle de lecture seule pour y accéder. Vous pouvez actuellement créer jusqu'à 40 rapports.

Le rapport « Violation de la politique » peut contenir plusieurs enregistrements pour un même appareil si plusieurs instances de tunnel ont été créées pour celui-ci. Ceci s'applique aussi bien aux rapports standard qu'aux rapports personnalisés.

## Génération de rapport

Vous pouvez planifier et générer un rapport.
...
4. Cliquez sur **Suivant**.**
 La page «** Détails du rapport » s'affiche. 
   - Indiquez un **nom de rapport**.
   - (Facultatif) Saisissez la **description** du rapport.
...
6. Pour les nouveaux rapports :
   - **Tous les événements**
   - **Jour précédent **
   - **Semaine précédente**
   - **Mois précédent**

7. Cliquez sur **Suivant**. La page Données du rapport s'affiche.
8. Cliquez sur **Personnaliser les colonnes** pour ajouter, supprimer ou réorganiser les colonnes dans la section **Colonnes du rapport** . Vous pouvez également cliquer sur le nom d'une colonne pour la supprimer.
9. (Facultatif) Utilisez la case à cocher **Sélectionner toutes les colonnes** pour sélectionner toutes les colonnes affichées dans la liste.
10. Cliquez sur **Restaurer les valeurs par défaut** pour rétablir les colonnes précédemment générées. Pour rétablir les colonnes sans aucune personnalisation, vous pouvez choisir un modèle sur la page **Choisir un modèle de rapport** .
11. Créez des filtres basés sur des règles spécifiques dans la section **Filtre avancé **.
...
12. (Facultatif) Vous pouvez cliquer sur l'icône **+** pour ajouter une autre règle ou sur l'icône **Ajouter un groupe** pour ajouter un autre groupe de règles.
13. ****La page Planification de rapport s'affiche.
14. Sélectionnez l'*un* des formats suivants pour télécharger le rapport :
    - CSV
    - PDF
    - **CSV et PDF** Pour les fichiers de rapport PDF, jusqu'à 10 colonnes sont autorisées. La section « Graphiques du rapport » affiche deux types de graphiques qui seront inclus dans les rapports PDF.
      **Toutes les applications** prennent uniquement en charge le format CSV.

15. Cliquez sur **Planification automatique** pour programmer l'exécution automatique d'un rapport en définissant sa récurrence. Vous pouvez également cliquer sur **Manuelle** pour exécuter le rapport une seule fois ; il vous sera alors envoyé par courriel.
...
16. Cliquez sur **Suivant**. La page de distribution du rapport s'affiche. Sélectionnez les destinataires du rapport.
17. (Facultatif) Ajoutez des ID d'e-mail externes en cliquant sur le lien **Ajouter une adresse e-mail externe**.
18. ************La page Récapitulatif de distribution du rapport s'affiche.
19. (Facultatif) Cliquez sur **Modifier** pour modifier votre rapport.
...
### Exécution d'actions sur un rapport depuis la page Rapports planifiés
...
| **Options d'actions** | **Action effectuée** |
 ...
 | **Modifier** | Permet de modifier le rapport. Le rapport permet également de consulter la plage sélectionnée dans la dernière version sous le nom « Plage précédente ». |
...
3. Cette page affiche les zones Récapitulatif des rapports et Historique des rapports.
