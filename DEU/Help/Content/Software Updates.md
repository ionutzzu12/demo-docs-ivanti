...
8. Select the following time options for the updates to happen:
   ...
   - End Time
   - Timezone
9. (Optional) Select the check box **Send OS update only once within the scheduled time** option to schedule updates for iOS devices.
10. Click **Next**.
11. Select the **Enable this configuration** option.
12. Select one of the following distribution options:
    - All Devices
    - No Devices (default)
    - Custom
13. Click **Done**.
...
- No Update Notifications During Active Hours – The update notification options are below.
