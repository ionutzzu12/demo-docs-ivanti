...
| Host                                      | Enter the host name of the mail server to use. Enter the fully qualified domain name of the ActiveSync server. If you are using a Standalone Sentry, enter its fully qualified domain name (FQDN) instead.<br />Example:<br />mySentry.mycompany.com |
...
| Trust All Certificates                    | Select only if you want the app to automatically accept untrusted certificates.<br />Typically, you select this option only when working in a test environment.                                                                                      |
| Default Email Signature                   | Enter the default email signature for all emails.<br />that the end user can change this at any time. Once the device user changes it, later changes to this field have no effect.                                                                   |
