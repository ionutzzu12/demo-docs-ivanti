...
- A cellular profile cannot be installed if an [**APN profile**](<./APN Configuration.md>) is already installed.
...
| APN Authentication Type  | (Optional) Select one of the following:<br />* CHAP (challenge handshake authentication protocol)
