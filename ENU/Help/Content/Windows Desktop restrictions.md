...
| **Control Panel**                 |                                                                                                                                                                                                                                                       |
| **Registry Editor**               |                                                                                                                                                                                                                                                       |
| **File Explorer**                 | Select the **Restrict Capabilities** checkbox to restrict capabilities of File Explore. Example: Removal of map network drive.<br />Click on the link provided to view the list of capabilities that are restricted.                                  |
| **Removable storage**             |                                                                                                                                                                                                                                                       |
