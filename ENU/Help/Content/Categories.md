...
If you cannot perform tasks on the **Content (Content)** page, it might be that you do not have the required permissions. You need the following [**role**](<./User Roles.md>):
