...
6. If needed, select a custom filter  to update.
   1. Click **Edit** to display the **Update Distribution Filter** page.
...
11. Choose a distribution filter option:
    1. Enter a filter name in the **Search the existing distribution filters**... field to locate a filter that has already been created.
