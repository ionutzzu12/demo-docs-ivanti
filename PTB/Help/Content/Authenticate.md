...
- should be registered with Access (Access profile should be configured).
...
6. Select one or both of the following OS option(s):
   ...
   - Windows
7. For macOS:
   1. In the Custom Data region, click **+ Add** to add keys and string values for custom data to be pushed to the devices.
...
8. For Windows 10 devices, this configuration helps in generating Command-Line arguments for the Authenticator MSI app for Windows as follows:
   1. Click **Done** to complete the Authenticate configuration.
